...
public class Tuple5<V0, V1, V2, V3, V4> implements Tuple {
    public final V0 v0;
    public final V1 v1;
    public final V2 v2;
    public final V3 v3;
    ...
    public Tuple5(V0 v0, V1 v1, V2 v2, V3 v3, V4 v4) {
    ...
    public String toString(){
        return "Tuple5{" + v0 + ", " + v1 + ", " + v2 + ", " + v3 + ", " + v4 + "}";
    }

    public List<Class> getParameterTypes(){
        return Arrays.asList(v0.getClass(), v1.getClass(), v2.getClass(), v3.getClass(), v4.getClass());
    }
